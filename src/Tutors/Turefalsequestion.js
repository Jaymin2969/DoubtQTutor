...
const Turefalsequestion = () => {

  useEffect(() => {
    document.title = 'DoubtQ - A reliable online True/False service for interactive knowledge evaluation';
  }, []);
  ...
  const { questionUnsolved, expertQuestion } = useSelector(
    (state) => state.question
  );
  const { postUnsolvedQuestionAns, postExpertQuestionAns } = useSelector((state) => state.question);
                    ...
                    <div className="rbt-dashboard-content bg-color-white rbt-shadow-box rbt-border mb--30 p--20">
                      <div className="content">
                        <div style={{ userSelect: "none" }} className="row">
                          ...
                          {question?.questionType.includes("exp") && <div className="col-md-12 col-lg-12 mb--20">
                            <h5>Explanation</h5>
                            <textarea
                        ...
                        <div className="row mt--20 pt--20 border-top">
                          ...
                          <div className="col-lg-6 col-8 text-end">
                            ...
                            <button
                              ...
                              disabled={apiLoading || (!answer && answer !== false)}
...
export default Turefalsequestion;
